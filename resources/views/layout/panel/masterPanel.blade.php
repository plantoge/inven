...
<head>
    ...
    <link href="{{ url('public/Twebsite/v1/plugins/custom/fullcalendar/fullcalendar.bundle.css') }}" rel="stylesheet"
        type="text/css" />
    ...
    <link href="{{ asset('public/Twebsite/v1/plugins/custom/toastr/toastr.min.css') }}" rel="stylesheet">
    <link href="{{ asset('/public/Twebsite/v1/plugins/custom/fontawesome6/css/all.css') }}" rel="stylesheet">
...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled aside-enabled bg-whit">
    ...
    <script src="{{ url('public/Twebsite/v1/js/jquery-3.6.3.min.js') }}"></script>
    ...
    <script src="{{ asset('public/Twebsite/v1/plugins/custom/toastr/toastr.min.js') }}"></script>
    <script src="{{ url('public/Twebsite/v1/plugins/custom/toastr/toastrku.js') }}"></script>
    <script src="{{ url('public/Twebsite/v1/plugins/custom/tambahan/moment/moment.js') }}"></script>
